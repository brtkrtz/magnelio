...
mesh-build campaign DD-201…DD-223).  Unreleased on `main`, feature by
feature in `CHANGELOG.md`: **DD-224 Phases A–D complete** (the API
...
(2026-09-01, with `CUPY_ACCELERATORS=""` — without it four GPU tests
...
* **API blueprint (DD-224) — Phases A–D complete** (listed above);
  ...
  must solve Maxwell itself, or it leaks.  Blueprint:
