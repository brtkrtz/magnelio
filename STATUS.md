...
DD-167 amends DD-157 with.  **known-bugs.md holds two open
...
DD-168.  The other open entry sits elsewhere: KB-023, CPML faces
that are not mirror images.  KB-024 was opened and closed the same day:
a missing pythonocc-core surfaced as an empty mesh because the mesher's
per-shape guards swallowed the backend's ImportError along with the
exotic-shape failures they were written for.
The
