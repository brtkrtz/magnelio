...
**resumable band runs** (DD-233, closes KB-037).  Unit 2795 / 4
skipped, integration 448 / 5 skipped (2026-08-31, with
...
* **Band-pipeline runtime** — 690x modal; split at p = 12: kernel
  71 %, convolution 13 %, march 4 %, postprocessing 14 %.  Rank
  reduction and the rational kernel both rejected (DD-233).  Leads: an
  exact blocked FFT convolution, the postprocessing, the fixed record.
