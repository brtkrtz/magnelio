...
On branch `fix/tangent-blend-straight-spine`, unreleased: **DD-249/
DD-250** — `lofted(blend="tangent")` between two facing faces builds
the eased taper (a Hermite loft on the plain loft's poles, exact zero
wall slope at both joints) instead of failing.
